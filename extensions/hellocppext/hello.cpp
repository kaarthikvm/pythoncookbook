...
static PyObject* myfunc_witharg(PyObject* self, PyObject *args) {
   ...
   std::cout<<"Item Description:       "<<item_desc<<std::endl;
   std::cout<<"Total ordered Quantity: "<<qty<<std::endl; 
...
static PyMethodDef hellocppext_API[] = {
...
PyMODINIT_FUNC inithellocppext(void) {
   Py_InitModule3("hellocppext", hellocppext_API,"Extension module example!");
}
